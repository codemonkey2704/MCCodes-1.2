...
function admin_index()
{
    global $ir, $c, $userid;
    print 
            "Welcome to the adam admin panel, <b>{$ir['username']}!</b><br />";
    echo <<<EOF
...
function sec_index()
{
    global $ir, $c;
    print 
            "Welcome to the adam secretary panel, {$ir['username']}!<br />
...
function ass_index()
{
    global $ir, $c;
    print 
            "Welcome to the adam assistant panel, {$ir['username']}!<br />
