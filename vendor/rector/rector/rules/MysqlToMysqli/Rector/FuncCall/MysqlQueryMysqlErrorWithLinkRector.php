...
final class MysqlQueryMysqlErrorWithLinkRector extends AbstractRector
{
     ...
     */
    private const FUNCTION_RENAME_MAP = ['mysql_affected_rows' => 'mysql_affected_rows', 'mysql_client_encoding' => 'mysql_character_set_name', 'mysql_close' => 'mysql_close', 'mysql_errno' => 'mysql_errno', 'mysql_error' => 'mysql_error', 'mysql_escape_string' => 'mysql_real_escape_string', 'mysql_get_host_info' => 'mysql_get_host_info', 'mysql_get_proto_info' => 'mysql_get_proto_info', 'mysql_get_server_info' => 'mysql_get_server_info', 'mysql_info' => 'mysql_info', 'mysql_insert_id' => 'mysql_insert_id', 'mysql_ping' => 'mysql_ping', 'mysql_query' => 'mysql_query', 'mysql_real_escape_string' => 'mysql_real_escape_string', 'mysql_select_db' => 'mysql_select_db', 'mysql_set_charset' => 'mysql_set_charset', 'mysql_stat' => 'mysql_stat', 'mysql_thread_id' => 'mysql_thread_id'];
    /**
...
CODE_SAMPLE
    ...
    private function findConnectionVariable(FuncCall $funcCall) : ?Expr
    {
        $connectionAssign = $this->betterNodeFinder->findFirstPrevious($funcCall, function (Node $node) : bool {
            ...
            return $node->expr instanceof FuncCall && $this->nodeNameResolver->isName($node->expr, 'mysql_connect');
        });
    ...
    private function isMysqliConnect(Variable $variable) : bool
    {
        return (bool) $this->betterNodeFinder->findFirstPrevious($variable, function (Node $node) use($variable) : bool {
            ...
            return $this->isName($node->expr, 'mysql_connect');
        });
    }
}
