...
<img src=bargreen.gif width=$hpperc height=10><img src=barred.gif width=$hpopp height=10></td></tr></table></div><center><b><u><a href='voting.php'>Vote for adam on various gaming sites and be rewarded!</a></u></b></center><br />
<center><b><u><a href='donator.php'>Donate to adam, it's only \$3 and gets you a lot of benefits!</a></u></b></center><br />
                ";
...
";
        if ($ir['fedjail'])
        {
            ...
            $r = mysql_fetch_array($q);
            die(
                    "<b><font color=red size=+1>You have been put in the adam Federal Jail for {$r['fed_days']} day(s).<br />
...
";
    ...
    function endpage()
    {
        ...
        <div style='font-style: italic; text-align: center'>
      		Powered by codes made by Dabomstew. Copyright &copy; {$year} adam.
    	</div>
        </body>
		</html>";
    }
