...
If you become a donator to adam, you will receive (each time you donate):<br />
<b>1st Offer:</b><ul>
...
<input type="hidden" name="business" value="adam@lol.com">
<input type="hidden" name="item_name" value="adam Donation for ($userid) (Pack 1)">
...
<input type="hidden" name="cmd" value="_xclick">
<input type="hidden" name="business" value="adam@lol.com">
<input type="hidden" name="item_name" value="adam Donation for ($userid) (Pack 2)">
<input type="hidden" name="amount" value="3.00">
<input type="hidden" name="no_shipping" value="1">
...
<input type="hidden" name="cmd" value="_xclick">
<input type="hidden" name="business" value="adam@lol.com">
<input type="hidden" name="item_name" value="adam Donation for ($userid) (Pack 3)">
<input type="hidden" name="amount" value="3.00">
<input type="hidden" name="no_shipping" value="1">
...
<input type="hidden" name="cmd" value="_xclick">
<input type="hidden" name="business" value="adam@lol.com">
<input type="hidden" name="item_name" value="adam Donation for ($userid) (Pack 4)">
...
<input type="hidden" name="cmd" value="_xclick">
<input type="hidden" name="business" value="adam@lol.com">
<input type="hidden" name="item_name" value="adam Donation for ($userid) (Pack 5)">
